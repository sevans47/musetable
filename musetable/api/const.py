...
NULLABLE_COLUMNS = [
    ...
    ('chords', 'sec_id'),
    ('chords', 'hp_id'),
    ('sections_form', 'sec_avg_rest_dur_in_mps'),
    ('sections_form', 'sec_med_rest_dur_in_mps'),
    ('sections_form', 'sec_std_mp_dur'),
    ('sections_form', 'sec_std_hp_dur'),
    ('sections_form', 'rest_dur_before_sec_first_note'),
    ('sections_form', 'rest_dur_after_sec_last_note'),
    ('sections_melody', 'sec_range_interval'),
    ('sections_melody', 'sec_range_midi'),
    ('sections_melody', 'sec_lowest_note_midi'),
    ('sections_melody', 'sec_highest_note_midi'),
    ('sections_melody', 'sec_to_chorus_range_diff'),
    ('sections_melody', 'sec_to_chorus_highest_note_dist'),
    ('sections_melody', 'sec_to_chorus_lowest_note_dist'),
    ('sections_melody', 'pct_into_sec_first_highest_note'),
    ('sections_melody', 'pct_into_sec_first_lowest_note'),
    ('sections_melody', 'sec_med_mp_highest_note'),
    ('sections_melody', 'sec_med_mp_lowest_note'),
    ('sections_melody', 'sec_dur_on_highest_note_pct'),
    ('sections_melody', 'sec_dur_on_lowest_note_pct'),
    ('sections_melody', 'sec_avg_pitch'),
    ('sections_melody', 'sec_most_common_pitch'),
    ('sections_melody', 'sec_most_common_pitch_pct'),
    ('sections_melody', 'sec_second_most_common_note_dur'),
    ('sections_melody', 'sec_second_most_common_note_dur_pct'),
    ('sections_melody', 'sec_n_nct_notes'),
    ('sections_melody', 'sec_dur_nct_notes'),
    ('sections_melody', 'sec_n_nct_notes_pct'),
    ('sections_melody', 'sec_dur_nct_notes_pct'),
    ('sections_melody', 'sec_up_pct'),
    ('sections_melody', 'sec_down_pct'),
    ('sections_melody', 'sec_same_pct'),
    ('sections_melody', 'sec_up_step_pct'),
    ('sections_melody', 'sec_up_skip_pct'),
    ('sections_melody', 'sec_up_leap_pct'),
    ('sections_melody', 'sec_down_step_pct'),
    ('sections_melody', 'sec_down_skip_pct'),
    ('sections_melody', 'sec_down_leap_pct'),
    ('notes_details', 'note_start_mp_offset'),
    ('chords_details', 'third_interval'),
    ('chords_details', 'fifth_interval'),
    ('chords_details', 'seventh_interval')
]
...
DATA_DICT = {
    ...
    'melodic_phrases_details': {
        ...
        # 'mp_start_section_m1b1_offset': [],  # can't do this yet, because I'm not dealing with time signature changes
        ...
        # 'mp_avg_hp_dur': [],  # hard to get and not interesting
        'mp_n_chords': [],
    },
    'harmonic_phrases': {
        'hp_id': [],
...
DATA_TYPE_DICT = {
    ...
    'tracks_form': {
        ...
        'track_med_rest_dur_in_mps': float,
        'track_med_rest_dur_between_mps': float,
        'track_n_mps': int,
        'track_n_hps': int,
        ...
        'track_med_mp_dur': float,
        'track_med_hp_dur': float,
    ...
    'tracks_melody': {
        ...
        'track_highest_note_midi': int,
        'track_lowest_note_midi': int,
        ...
        'track_med_mp_highest_note': float,
        'track_med_mp_lowest_note': float,
        ...
        'track_avg_pitch': int,
        'track_most_common_pitch': str,
        'track_most_common_pitch_pct': float,
        'track_longest_note_dur': float,
        'track_most_common_note_dur': str,
        'track_most_common_note_dur_pct': float,
        'track_second_most_common_note_dur': str,
    ...
    'tracks_harmony': {
        ...
        'track_avg_hp_dur': float,
        'track_med_chord_dur': float,
        'track_med_chord_center_dur': float,
        'track_med_hp_dur': float,
        'track_n_chords': int,
    ...
    'sections_form': {
        'sec_id': str,
        'sec_start_note_id': str,
        'sec_end_note_id': str,
        'sec_start_chord_id': str,
        'sec_end_chord_id': str,
        'sec_start_mp_id': str,
        'sec_end_mp_id': str,
        'sec_note_dur': float,
        'sec_note_dur_pct': float,
        'sec_rest_dur': float,
        'sec_rest_dur_pct': float,
        'sec_rest_dur_in_mps': float,
        'sec_rest_dur_in_mps_pct': float,
        'sec_rest_dur_between_mps': float,
        'sec_rest_dur_between_mps_pct': float,
        'sec_avg_rest_dur_in_mps': float,
        'sec_avg_rest_dur_between_mps': float,
        'sec_med_rest_dur_in_mps': float,
        'sec_med_rest_dur_between_mps': float,
        'sec_n_notes': int,
        'sec_n_chords': int,
        'sec_n_mps': int,
        'sec_n_hps': int,
        'sec_n_unique_mps':int,
        'sec_n_unique_hps':int,
        'sec_avg_mp_dur': float,
        'sec_avg_hp_dur': float,
        'sec_med_mp_dur': float,
        'sec_med_hp_dur': float,
        'sec_to_track_avg_mp_dur': float,
        'sec_to_track_avg_hp_dur': float,
        'sec_to_track_med_mp_dur': float,
        'sec_to_track_med_hp_dur': float,
        'sec_to_chorus_dur': float,
        'sec_to_chorus_avg_mp_dur': float,
        'sec_to_chorus_avg_hp_dur': float,
        'sec_to_chorus_med_mp_dur': float,
        'sec_to_chorus_med_hp_dur': float,
        'sec_std_mp_dur': float,
        'sec_std_hp_dur': float,
        # 'form_mps': str,
        # 'form_mps_subphrases': str,
        'rest_dur_before_sec_first_note': float,
        'rest_dur_after_sec_last_note': float,
    },
    'sections_melody': {
        'sec_id': str,
        'sec_range_interval': str,
        'sec_range_midi': int,
        'sec_lowest_note_midi': int,
        'sec_highest_note_midi': int,
        'sec_to_chorus_range_diff': int,
        'sec_to_chorus_highest_note_dist': int,
        'sec_to_chorus_lowest_note_dist': int,
        'sec_first_highest_note_id': str,
        'sec_first_lowest_note_id': str,
        'pct_into_sec_first_highest_note': float,
        'pct_into_sec_first_lowest_note': float,
        'sec_has_track_highest_note': bool,
        'sec_has_track_lowest_note': bool,
        'sec_has_track_widest_range': bool,
        'sec_has_track_narrowest_range': bool,
        'sec_med_mp_highest_note': float,
        'sec_med_mp_lowest_note': float,
        'sec_n_highest_note': int,
        'sec_dur_on_highest_note': float,
        'sec_n_lowest_note': int,
        'sec_dur_on_lowest_note': float,
        'sec_dur_on_highest_note_pct': float,
        'sec_n_notes_on_highest_note_pct': float,
        'sec_dur_on_lowest_note_pct': float,
        'sec_n_notes_on_lowest_note_pct': float,
        'sec_avg_pitch': int,
        'sec_most_common_pitch': str,
        'sec_most_common_pitch_pct': float,
        'sec_longest_note_dur': float,
        'sec_has_track_longest_note': bool,
        'sec_most_common_note_dur': str,
        'sec_most_common_note_dur_pct': float,
        'sec_second_most_common_note_dur': str,
        'sec_second_most_common_note_dur_pct': float,
        'sec_n_nct_notes': int,
        'sec_dur_nct_notes': float,
        'sec_n_nct_notes_pct': float,
        'sec_dur_nct_notes_pct': float,
        'sec_up_pct': float,
        'sec_down_pct': float,
        'sec_same_pct': float,
        'sec_up_step_pct': float,
        'sec_up_skip_pct': float,
        'sec_up_leap_pct': float,
        'sec_down_step_pct': float,
        'sec_down_skip_pct': float,
        'sec_down_leap_pct': float,
    },
    'sections_harmony': {
        'sec_id': str,
        'sec_avg_chord_dur': float,
        'sec_avg_chord_center_dur': float,
        'sec_avg_hp_dur': float,
        'sec_med_chord_dur': float,
        'sec_med_chord_center_dur': float,
        'sec_med_hp_dur': float,
        'sec_n_chords': int,
        'sec_n_unique_chords': int,
        'sec_n_chord_centers': int,
        'sec_pct_3_note_chords_or_fewer': float,
        'sec_pct_4_note_chords_or_more': float,
        'sec_pct_maj_3_no_7': float,
        'sec_pct_min_3_no_7': float,
        'sec_pct_maj_3_maj_7': float,
        'sec_pct_min_3_min_7': float,
        'sec_pct_maj_3_min_7': float,
        'sec_pct_other_quality': float,
        'sec_to_chorus_first_chord_root_dist': int,
        'sec_to_chorus_first_chord_bass_dist': int,
    },
    'melodic_phrases': {
        'mp_id': str,
        'sec_id': str,
    ...
    'melodic_phrases_details': {
        'mp_id': str,
        'mp_n_notes': int,
        'mp_range_interval': str,
        'mp_range_midi': int,
        'mp_highest_note_midi': int,
        'mp_lowest_note_midi': int,
        'mp_start_note_id': str,
        'mp_end_note_id': str,
        'mp_note_dur': float,
        'mp_note_dur_pct': float,
        'mp_rest_dur': float,
        'mp_rest_dur_pct': float,
        'rest_dur_before_mp': float,
        'rest_dur_after_mp': float,
        'mp_start_section_offset': float,
        'mp_to_track_avg_mp_dur': float,
        'mp_to_track_med_mp_dur': float,
        'mp_has_track_highest_note': bool,
        'mp_has_track_lowest_note': bool,
        'pct_into_mp_first_highest_note': float,
        'pct_into_mp_first_lowest_note': float,
        'has_sec_highest_note': bool,
        'has_sec_lowest_note': bool,
        'has_sec_widest_range': bool,
        'has_sec_narrowest_range': bool,
        'mp_dur_on_highest_note': float,
        'mp_n_highest_note': int,
        'mp_n_notes_on_highest_note_pct': float,
        'mp_dur_on_highest_note_pct': float,
        'mp_dur_on_lowest_note': float,
        'mp_n_lowest_note': int,
        'mp_n_notes_on_lowest_note_pct': float,
        'mp_dur_on_lowest_note_pct': float,
        'mp_avg_pitch': int,
        'mp_most_common_pitch': str,
        'mp_most_common_pitch_pct': float,
        'mp_longest_note_dur': float,
        'has_track_longest_note': bool,
        'mp_most_common_note_dur': str,
        'mp_most_common_note_dur_pct': float,
        'mp_second_most_common_note_dur': str,
        'mp_second_most_common_note_dur_pct': float,
        'has_sec_longest_note': bool,
        'mp_n_notes': int,
        'mp_n_nct_notes': int,
        'mp_dur_nct_notes': float,
        'mp_n_nct_notes_pct': float,
        'mp_dur_nct_notes_pct': float,
        'mp_up_pct': float,
        'mp_down_pct': float,
        'mp_same_pct': float,
        'mp_up_step_pct': float,
        'mp_up_skip_pct': float,
        'mp_up_leap_pct': float,
        'mp_down_step_pct': float,
        'mp_down_skip_pct': float,
        'mp_down_leap_pct': float,
        'mp_avg_chord_dur': float,
        'mp_avg_chord_center_dur': float,
        'mp_n_chords': int,
    },
    'harmonic_phrases': {
        'hp_id': str,
    ...
    'harmonic_phrases_details': {
        'hp_id': str,
        'hp_n_chords': int,
        'hp_start_chord_id': str,
        'hp_end_chord_id': str,
        'hp_start_section_offset': float,
        'hp_to_track_avg_hp_dur': float,
        'hp_to_track_med_hp_dur': float,
        'hp_avg_chord_dur': float,
        'hp_avg_chord_center_dur': float,
        'hp_med_chord_dur': float,
        'hp_med_chord_center_dur': float,
        'hp_n_chords': int,
        'hp_n_unique_chords': int,
        'hp_n_chord_centers': int,
        'hp_pct_maj_3_no_7': float,
        'hp_pct_min_3_no_7': float,
        'hp_pct_maj_3_maj_7': float,
        'hp_pct_min_3_min_7': float,
        'hp_pct_maj_3_min_7': float,
        'hp_pct_other_quality': float,
        'hp_to_chorus_first_chord_root_dist': int,
        'hp_to_chorus_first_chord_bass_dist': int,
        'pct_repeated_chords': float,
        'pct_chord_center_elongation': float,
        'chord_names': str,
        'chord_durs': str,
        'chord_center_durs': str,
        'chord_change_beats': str,
        'chord_center_change_beats': str,
        'root_motion': str,
        'bass_motion': str,
        'n_chord_qualities': int,
        'n_2_note_chords': int,
        'n_3_note_chords': int,
        'n_4_note_chords': int,
        'n_5plus_note_chords': int,
        'dur_2_note_chords': float,
        'dur_3_note_chords': float,
        'dur_4_note_chords': float,
        'dur_5plus_note_chords': float,
        'hp_overlaps_next_section': bool,
        'all_chord_dur_are_same': bool,
        'hp_to_chorus_first_chord_root_dist': int,
        'hp_to_chorus_first_chord_bass_dist': int,
        'hp_to_track_avg_chord_dur': float,
        'hp_to_track_med_chord_dur': float,
    },
    'notes': {
        'note_id': str,
        'sec_id': str,
    ...
    'notes_details': {
        'note_id': str,
        'note_start_section_offset': float,
        'note_start_mp_offset': float,
        'spans_multi_chords': bool,
        'is_sec_highest_note': bool,
        'is_sec_lowest_note': bool,
        'is_track_highest_note': bool,
        'is_track_lowest_note': bool,
        'is_track_longest_note': bool,
        'is_sec_longest_note': bool,
        'is_phrase_longest_note': bool,
        'up': bool,
        'down': bool,
        'same': bool,
        'up_step': bool,
    ...
    'chords_details': {
        'chord_id': str,
        'chord_start_section_offset': float,
        'third_interval': str,
        'fifth_interval': str,
        'seventh_interval': str,
        'has_extension': bool,
        'has_added_notes': bool,
        'has_maj_3_no_7': bool,
        'has_min_3_no_7': bool,
        'has_maj_3_maj_7': bool,
        'has_min_3_min_7': bool,
        'has_maj_3_min_7': bool,
        'has_other_quality': bool,
        'chord_unique_to_sec': bool,
        'chord_quality_unique_to_sec': bool,
        'chord_root_unique_to_sec': bool,
        'chord_bass_unique_to_sec': bool,
        'n_sec_with_same_chord': int,
        # 'n_unique_secs_with_same_chord': int,
        'chord_unique_to_hp': bool,
        'chord_quality_unique_to_hp': bool,
        'chord_root_unique_to_hp': bool,
        'chord_bass_unique_to_hp': bool,
        'n_hp_with_same_chord': int,
        'chord_unique_in_track': bool,
        'chord_quality_unique_in_track': bool,
        'chord_root_unique_in_track': bool,
        'chord_bass_unique_in_track': bool,
        'chord_to_chorus_first_chord_root_dist': int,
        'chord_to_chorus_first_chord_bass_dist': int,
    },
}
